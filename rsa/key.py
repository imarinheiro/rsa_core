...
def select_e(tocient):
    ...
    :return: retorna o número relativamente primo com base no parâmetro
    """
...
def calculate_d(e, tocient):
    """
    Retorna o número d tal que, (e * d) mod tociente = 1
    Desde que d tenha o mesmo sinal de tociente. Se nenhum valor existir a exceção ValueError é lançado.
